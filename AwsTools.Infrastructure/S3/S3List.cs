...
namespace AwsTools.Infrastructure.S3
{
    /// <summary>
    /// S3の
    /// </summary>
    public sealed class S3List
    {
        public void exe()
        {
            ...
            args[0] = "www.u10.jp";
            Task t = MainExecute(args);
            t.Wait();
            Console.WriteLine("END");
        }

        // Main method
        public async Task MainExecute(string[] args)
        {
            Environment.SetEnvironmentVariable("AWS_PROFILE", "terraform");
